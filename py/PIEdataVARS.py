...
def buildalldatathings(userdict, labdict, invlabs):
    ...
    itemlist = [contacts, goldstars, pdis, shifts,locations, invreports, appointments, activerusers, graveyardheads, schedules, assignedbadges, employeeMeetings, contactslong, attendance_issues, chat_messages]
